    ...
    <>
      ...
      <div className="relative pt-36 md:pt-48 pb-14 mx-auto  px-4 lg:px-8 bg-white text-black">
        <article className="prose prose-slate mx-auto">
          ...
          <p>
            Welcome to <strong>ResumeDesk</strong>.
          </p>
          <p>
            ResumeDesk (“us”, “we”, or “our”) operates <a href="https://ResumeDesk.rkph.me">https://ResumeDesk.rkph.me</a> (hereinafter
            referred to as “<strong>Service</strong>”).
          </p>
          <p>
            Our Privacy Policy governs your visit to <a href="https://ResumeDesk.rkph.me">https://ResumeDesk.rkph.me</a>, and
          ...
          <h3>2. Definitions</h3>
          <p>
            <strong>SERVICE</strong> means the https://ResumeDesk.rkph.me website operated by ResumeDesk.
          </p>
          <p>
          ...
          <p>
            ResumeDesk&#39;s use and transfer of information received from Google APIs to any other app will adhere to{" "}
          ...
          <p>
            You can sign up with your Google account so your ResumeDesk account username will be prefilled with your name and
            your public profile picture.
          </p>
          <p>
            You have the option to &#39;Add Documents&#39; on your ResumeDesk page, allowing you to connect Google Docs files
            set to share with a publicly accessible Google Docs URL. Additionally, you can add Notion databases/pages
            that you, the USER, have granted access to through the ResumeDesk integration. This enables ResumeDesk to access and
            parse document content, compiling word count data to track your writing progress. Please note that this
            information is used exclusively for writing activity tracking features within ResumeDesk and is not shared
            externally.
          </p>
          <p>
          ...
          <p>
            ...
            through ResumeDesk and the services in terms of the applicable Indian data protection laws.
          </p>{" "}
          <p>
          ...
          <h3>5. Use of Data</h3>
          <p>ResumeDesk uses the collected data for various purposes:</p>
          <ol>
          ...
          <p>
            ResumeDesk will take all the steps reasonably necessary to ensure that your data is treated securely and in
          ...
          <p>By email: hello@rikiphukon[dot]com</p>
