...
# BRIEFING REPORT 0x69420                                                              1/n?

SUBJECT: A FORMAL INQUIRY INTO MAKING COOL SH*T
EARTH DATE: FEB 02, 2025
========== ========== ========== ========== ========== ========== ========== ==========

## OVERVIEW

┌──────────────────────┬──────────────┬──────────────────────────────────────────┐
│ Parameter            │ Conc. (ppm)  │ Notes                                    │
├──────────────────────┼──────────────┼──────────────────────────────────────────┤
│ Experimentation      │         9000 │ No guardrails, full send                 │
│ Niche Ideas          │         8500 │ If it's weird, we're probably into it    │
│ Delight Factor       │        99999 │ Surprise, joy, and “wtf, that’s cool”    │
│ Funding              │          TBD │ Manifesting $$$                          │
└──────────────────────┴──────────────┴──────────────────────────────────────────┘

FAFO Labs is committed to pushing boundaries, writing good software, building wonderful
hardware, and exploring the unknown—just because we can.

If we’re not discovering something new (or breaking something old), are we even trying?
Expect the unexpected. Build with reckless curiosity. Iterate with abandon. Come build.


[GitHub](https://github.com/fafo-labs) | [X](https://x.com/_fafolabs)
[ResumeDesk](https://github.com/fafo-labs/resumedesk)

========== ========== ========== ========== ========== ========== ========== ==========

`;
  return (
    <svg width="950" height="648" viewBox="0 0 1010 648" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
      ...
      <foreignObject x="68" y="0" width="875" height="648" style={{ overflowY: 'clip' }}>
        <pre
          ...
          className="--local-departure-mono text-black mt-6 p-10 [&::selection]:bg-black [&::selection]:text-white"
        >
          {altMissionReport}
        </pre>
      </foreignObject>
